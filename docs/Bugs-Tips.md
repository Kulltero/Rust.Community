...
Rust UI uses the same Placement system CUI does. it primarily uses offsets for sizing & positioning, or the middle depending on the of the Screen and then uses offsets to position each element. by doing the same you can ensure that your CUI is positioned properly, regardless of Screensize & Aspect Ratio.
...
**< [Previous Topic](/docs/components/README.md)** | **[Back to the Start](/README.md)** | **[Next Topic](/README.md) >**
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0MTE1MjQxMiwtMjI0MjA5OTAzLC04Mz
